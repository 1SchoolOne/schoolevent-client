import { Card, Row, Col, Statistic, Button, Typography, Space, ConfigProvider } from 'antd';
...
export const VisitsMonthWidget: React.FC = () => {
  ...
  return (
    <ConfigProvider locale={frFR}>
      <Card title="Nombre de participation par mois" size="small" bordered={true} className="visitsmonth-widget">
        <Row>
          <Col span={2}>
            <EyeOutlined />
          </Col>
          <Col span={22}>
            <Statistic title="Nombre total de participation du mois" value={visits} formatter={formatter} />
          </Col>
        </Row>
        <hr/>
